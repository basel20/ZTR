...
import driving from './Activities/driving.jpg'
import driving1 from './Activities/driving1.jpg'
import driving2 from './Activities/driving2.jpg'
import driving3 from './Activities/driving3.jpg'
import driving4 from './Activities/driving4.jpg'
import driving5 from './Activities/driving5.jpg'

import dreamland from './Activities/dreamland.jpg'
import dreamland1 from './Activities/dreamland1.jpg'
import dreamland2 from './Activities/dreamland2.jpg'
import dreamland3 from './Activities/dreamland3.jpg'
import dreamland4 from './Activities/dreamland4.jpg'
import dreamland5 from './Activities/dreamland5.jpg'

import carting from './Activities/carting.jpg'
import carting1 from './Activities/carting1.jpg'
import carting2 from './Activities/carting2.jpg'
import carting3 from './Activities/carting3.jpg'
...
export const AllHotels = [
  {
    id: "stregis",
    hotel: "فندق سانت ريجيس موسكو نيكولسكايا",
    description: "فندق سانت ريجيس موسكو نيكولسكايا هو فندق فاخر يقع في موسكو، روسيا. يتميز الفندق بموقعه المركزي القريب من معالم الجذب السياحية الشهيرة في المدينة. تتميز غرف الفندق بالأناقة والرفاهية، مع إطلالات رائعة على المدينة.\n يقدم الفندق مجموعة من المرافق الراقية، بما في ذلك مطاعم فاخرة ومرافق للياقة البدنية ومنتجع صحي يوفر للنزلاء تجربة استرخاء فريدة. تجمع خدمات الضيافة الراقية في فندق سانت ريجيس موسكو نيكولسكايا بين الأناقة والراحة لتوفير إقامة لا تُنسى للزوار في مدينة موسكو.",
  ...
  },
  {
    id: "fourseason",
    hotel: "فندق فور سيزونز",
    description: "يقع هذا الفندق الفاخر في مبنى مذهل مستوحى من ثلاثينيات القرن العشرين، على بُعد دقيقتين سيرًا على الأقدام من أقرب محطة مترو أنفاق و10 دقائق سيرًا على الأقدام من الساحة الحمراء وكيلومتر واحد من الكرملين. \n تتوفر في الغرف الأنيقة خدمة Wi-Fi مجانية وأجهزة تلفزيون بشاشات مسطحة. بالإضافة إلى ما سبق، تضم الغرف الأعلى درجة مساحات للجلوس و/أو شرفات. تحتوي الأجنحة على غرف معيشة مع مدافئ، بينما تتميز الأجنحة الفخمة الأعلى درجة بتراسات وغرف طعام وأرائك تتحوّل إلى أسرّة و/أو غرف ساونا. خدمة الغرف متاحة 24/7.\n تشمل وسائل الراحة مطعمًا إيطاليًا ومطعمًا صغيرًا عصريًا ومقهى مريحًا، فضلاً عن بارين. ويضم الفندق أيضًا منتجعًا صحيًا وناديًا رياضيًا متاحًا على مدار الساعة ومسبحًا داخليًا بسقف زجاجي، فضلاً عن مغطس مياه ساخنة وحمّام ساونا.",
    img: featuredHotel3,
  ...
  },
  {
    ...
    description: "يقع هذا الفندق الفاخر على طراز الفن الحديث في مبنى كبير يضم ردهة مركزية، ويبعد 4 دقائق سيرًا على الأقدام عن كل من محطة المترو ومسرح البولشوي و15 دقيقة سيرًا على الأقدام عن الكرملين في موسكو. تحتوي الغرف الفاخرة والمفروشة بالتحف على ميني بارات وخدمة الواي فاي المجانية وأجهزة تلفزيون بشاشات مسطحة.\n وتوفر بعضها إطلالات على المدينة. وتتميز الأجنحة بغرف معيشة وآلات نسبريسو، بينما تضم ​​الأجنحة الأعلى درجة حمّامات ساونا. خدمة الغرف متاحة 24/7.  يضم الفندق مطعمًا راقيًا وعريقًا وبارًا/صالة جلوس أنيقة تقدم كوكتيلات على طراز التاروت، وقاعة حفلات كبيرة في ردهة ذات سقف من الزجاج الملون. تتوفر وجبة الإفطار مقابل رسوم.",
    img: metropol,
  ...
  },
  {
    ...
    description: "يعود هذا الفندق الفاخر إلى عام 1898، ويطل على نهر موسكفا، ويبعد 9 دقائق سيرًا على الأقدام عن مترو موسكو و15 دقيقة سيرًا على الأقدام عن كاتدرائية القديس باسيل في الساحة الحمراء. توفر الغرف الأنيقة ذات الأسقف العالية خدمة الواي فاي المجانية وأجهزة تلفزيون بشاشات مسطحة وقواعد للآي بود. ويضم بعضها مناطق للجلوس و/أو يطل على الكرملين.\n تضيف جميع الأجنحة غرف معيشة منفصلة، بينما يتميز بعضها بتصميمات داخلية مخصصة صممها أفراد العائلة المالكة الأوروبية. يضم الفندق مطعمًا فاخرًا، بالإضافة إلى صالة جلوس في قاعة الانتظار تقدم الشاي بعد الظهر وبارًا/مطعمًا مع ترّاس. وتشمل وسائل الراحة الأخرى منتجعًا صحيًا أنيقًا يضم مسبحًا داخليًا ومركزًا للياقة البدنية وصالونًا، فضلاً عن 12 مساحة للاجتماعات.",
    img: kempinski,
  ...
  },
  {
    ...
    description: "يقع هذا الفندق التاريخي الفاخر في مبنى كبير يعود إلى عام 1903، ويبعد كيلومترين عن 'الساحة الحمراء' و4 كيلومتر عن 'كرملين موسكو'. تتميز الغرف المشرقة بمفروشات تعود إلى القرن التاسع عشر وتحتوي على أجهزة تلفزيون بشاشات مسطحة وخدمة الواي فاي المجانية.\n بالإضافة إلى ما سبق، تضم الغرف الأعلى درجة والأجنحة المليئة بالتحف مساحات منفصلة للجلوس و/أو إطلالات على الكرملين. خدمة الغرف متاحة 24/7. تشمل وسائل الراحة مطعمَين راقيَين وبارًا راقيًا في ساحة فناء مغلقة ذات سقف زجاجي. يضم الفندق أيضًا ناديًا رياضيًا ومسبحًا داخليًا ومغطس مياه ساخنة، فضلاً عن مساحة للاجتماعات والفعاليات.",
    img: national,
  ...
  },
  {
    ...
    description: "يقع هذا الفندق الفاخر في مبنى كلاسيكي جديد على بعد 11 دقيقة سيرًا على الأقدام من مسرح البولشوي وأقل من كيلومتر واحد من الكرملين بموسكو وكيلومترين من كاتدرائية القديس بطرس. كاتدرائية باسيل.  تتوفر في الغرف الأنيقة، التي يطلّ بعضها على المدينة، خدمة Wi-Fi مجانية وأجهزة تلفزيون بشاشات مسطحة وآلات نسبريسو، بالإضافة إلى حمامات رخامية.\n تضيف الأجنحة الفخمة مناطق معيشة منفصلة. يضم بعضها غرفًا لتناول الطعام و/أو أحواض جاكوزي و/أو مطابخ. خدمة الغرف متاحة 24/7.  تشمل وسائل الراحة مطعمين أنيقين وصالة جلوس راقية وبارًا فخمًا على السطح مع ترّاس موسمي وإطلالات على المدينة. ويضم الفندق أيضًا مركزًا للياقة البدنية ومنتجعًا صحيًا مع مسبح داخلي. تتوفر مواقف للسيارات (مقابل رسوم) ووجبة الإفطار.",
    img: carlton,
...
export const AllActivities = [
  ...
  {
    id: "driving",
    name: "الدريفنج او التفحيط ",
    description:"هل تبحث عن تجربة مليئة بالأدرينالين؟ هل تريد اختبار مهاراتك القيادية في بيئة آمنة ومسيطر عليها؟ هل ترغب في الانضمام إلى مجتمع من عشاق السيارات الذين يشاركون شغفك؟ إذا كان الأمر كذلك، فلدينا ما تبحث عنه!\n جرّب تجربة الدريفنج أو التفحيط في موسكو، عاصمة الإثارة! معنا، ستتمكن من:القيادة بسيارات فائقة السرعة على حلبة سباق مُخصصة. تعلم تقنيات القيادة الاحترافية من مدربين ذوي خبرة. اختبار مهاراتك في بيئة آمنة ومسيطر عليها. التنافس مع أصدقائك أو زملائك في سباقات مثيرة. الانضمام إلى مجتمع من عشاق السيارات الذين يشاركون شغفك. لا تنتظر أكثر! احجز رحلتك إلى موسكو اليوم!\n  مميزات تجربة الدريفنج أو التفحيط في موسكو: حلبات سباق مُخصصة و مُجهزة بأحدث التقنيات. سيارات فائقة السرعة من مختلف الماركات العالمية. مدربون ذوو خبرة ومهنية عالية. بيئة آمنة ومسيطر عليها. أسعار تنافسية. فرصة للتعرف على أشخاص جدد و مشاركة شغفك بالسيارات. لا تُفوّت هذه الفرصة الفريدة! احجز رحلتك إلى موسكو اليوم",
    img: driving,
    imgList: [{id:1, img:driving1}, {id:2, img:driving2},  {id:3, img:driving3}, {id:4, img:driving4}, {id:5, img:driving5},],
    link: "/activities/driving",
  },
  {
    id: "dreamlandpark",
    name: "دريم لاند بارك ",
    description:"جزيرة الأحلام في موسكو وهو أكبر مدينة ملاهي في أوروبا. يضم منتزه دريم لاند  تسعة أقسام  بموضوعات مختلفة، بما في ذلك:سحر الطفولة بألعاب تناسب الأطفال الصغار. مغامرة القرون الوسطى بألعاب مثيرة وخيالية. مدينة المستقبل بألعاب تكنولوجية حديثة. القرية الروسية بألعاب تقليدية وأنشطة ثقافية. حديقة الحيوانات مع مجموعة متنوعة من الحيوانات من جميع أنحاء العالم. يضم منتزه دريم لاند أيضًا  حديقة مائية  مع منزلقات مائية وأحواض سباحة، و ساحة تزلج على الجليد  و مسرح  يقدم عروضًا حية.\n  منتزه دريم لاند هو وجهة مثالية للعائلات مع أطفال من جميع الأعمار.  إليك بعض الأشياء التي يمكنك القيام بها في منتزه دريم لاند:استمتع بركوب الألعاب المثيرة، مثل قطار الموت وبرج الجري. شاهد عرضًا حيًا في المسرح. قم بزيارة حديقة الحيوانات و تعرف على الحيوانات المختلفة. استمتع بالسباحة في الحديقة المائية. تناول الطعام في أحد المطاعم العديدة في المنتزه. \nمنتزه دريم لاند هو مكان رائع لقضاء يوم من المرح والإثارة مع العائلة والأصدقاء. تأكد من زيارة هذا المنتزه الرائع عند سفرك إلى موسكو!",
    img: dreamland,
    imgList: [{id:1, img:dreamland1}, {id:2, img:dreamland2},  {id:3, img:dreamland3}, {id:4, img:dreamland4}, {id:5, img:dreamland5},],
    link: "/activities/dreamlandpark",
  },
  {
    id: "carting",
    name: "الكارتينج ",
    description:"مغامرة الكارتينج على الثلج في موسكو: تجربة شتوية فريدة من نوعها! هل تبحث عن تجربة شتوية مثيرة في موسكو؟ انطلق في مغامرة الكارتينج على الثلج! تخيل نفسك تتحدى المنعطفات الحادة وانزلاقات ممتعة على مسار ثلجي مغطى بالكامل، بينما تستمتع بجمال المناظر الطبيعية الخلابة في موسكو. اختبر شعور الانزلاق على مسار ثلجي مع والتحكم   بكامل قوتها.\n مناظر طبيعية خلابة: استمتع بجمال موسكو الشتوي بينما تتسابق عبر المسار. نشاط مناسب للجميع: سواء كنت محترفًا في الكارتينج أو مبتدئًا، ستجد متعة لا مثيل لها في هذه التجربة. مغامرة مثالية للعائلة: اجمع العائلة والأصدقاء وشاركوا هذه التجربة المثيرة.\n لا تفوّت فرصة تجربة الكارتينج على الثلج في موسكو! إنها مغامرة شتوية فريدة من نوعها ستبقى محفورة في ذاكرتك للأبد.",
    img: carting,
    imgList: [{id:1, img:carting1}, {id:2, img:carting2},  {id:3, img:carting3}, {id:4, img:carting4}, {id:5, img:carting5},],
...
export const AllRestaurants = [
  {
    ...
    imgList: [{id:1, img:bulshoi1},{id:2, img:bulshoi2},{id:3, img:bulshoi3},{id:4, img:bulshoi4}],
    link: "/resturants/bolshoi", 
},
{
    id: "turandot",
