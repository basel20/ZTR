    ...
    return(
        <Section header='Our Services'>
            <Stack width={{md:'100%'}} height={{xs:'250px',md:'300px'}} direction={{ md:'row'}} alignItems='center' justifyContent='center' borderTop={'5px solid #005A5A'} borderBottom={'5px solid #005A5A'}>
                <Box sx={{width:{ xs:'100%',md:'50%'},height:'98%', display:'flex', flexDirection:'column',justifyContent:'center', pl:{md:'5%',lg:'10%'}}} 
                borderTop={'5px solid #b9b083'} borderBottom={'5px solid #b9b083'}>

                    <Typography fontSize={{xs:'24px',md:'26px'}}  textAlign={{xs:'center', md:'left'}} lineHeight='20px' fontWeight={700} color='#005A5A' opacity='1'>
                    <RadioButtonCheckedIcon sx={{mr:1, pt:0.5, color:'#b9b083'}}/>Private car delivery service
                    </Typography>
                    <Typography fontSize={{xs:'24px',md:'26px'}}  textAlign={{xs:'center', md:'left'}} lineHeight='40px' fontWeight={700} color='#005A5A' opacity='1'>
